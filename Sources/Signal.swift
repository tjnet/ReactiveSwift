...
public final class Signal<Value, Error: Swift.Error> {
	...
	private final class Core {
		...
		private func removeObserver(with token: RemovalToken) {
			updateLock.lock()
		...
		private func tryCommitTermination(acquired sendLock: NSLock? = nil) -> OperationResult {
			...
			let _sendLock: NSLock? = sendLock == nil ? self.sendLock : nil
...
private final class AliveState<Value, Error: Swift.Error> {
	...
	fileprivate var observers: Bag<Signal<Value, Error>.Observer>
